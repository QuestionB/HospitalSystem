...
public class patient_window {
	...
	private  void initialize() { 
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					x=Client.login(textField.getText(),String.valueOf(passwordField.getPassword()),3);//登陆
				} catch (IOException e) {
				...
				lblNewLabel_5.setVisible(true);//新页面预约
				...
				if(x==3){//登陆失败
					...
					lblNewLabel_2.setText("密码错误");
					}
				
				else if(x==2){//登陆失败
					lblNewLabel_2.setVisible(true);
					lblNewLabel_2.setText("用户名不存在");
					}
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {//注册
				int x=0;
				 try {
					x=Client.addUser(textField.getText(), String.valueOf(passwordField.getPassword()), 2, 1); //病人类型为2，注册类型号为1
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} 
				 if(x==1){
				 lblNewLabel_2.setVisible(true);
					lblNewLabel_2.setText("注册成功");}
				 if(x==4){
					 lblNewLabel_2.setVisible(true);
						lblNewLabel_2.setText("用户名已存在");}
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {//预约
				int x=0;   
		...
		lblNewLabel_3.setBounds(0, 0, 794, 565);
